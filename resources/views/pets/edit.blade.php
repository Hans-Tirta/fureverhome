    ...
    <div class="min-h-screen bg-background-primary py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-8">
                <h1 class="text-3xl font-bold text-text-primary">Edit Pet</h1>
                ...
                <form method="POST" action="{{ route('pets.update', $pet) }}" enctype="multipart/form-data">
                    ...
                    <div class="p-6 space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="size"
                                        ...
                                        <option value="small"
                                            {{ old('size', $pet->size) == 'small' ? 'selected' : '' }}>Small</option>
                                        <option value="medium"
                                            {{ old('size', $pet->size) == 'medium' ? 'selected' : '' }}>Medium</option>
                                        <option value="large"
                                            {{ old('size', $pet->size) == 'large' ? 'selected' : '' }}>Large</option>
                                    </select>
                                    @error('size')
                                        <p class="text-accent-red text-sm mt-1">{{ $message }}</p>
                                    @enderror
                        ...
                        <div>
                            ...
                            <p class="text-sm text-text-secondary mb-2">Uploading new images will replace existing
                                images. The first image will be used as the primary display image.</p>
                        ...
                        <div class="flex items-center justify-end gap-3 pt-4 border-t border-background-secondary">
                            ...
                            <button type="submit"
                                class="px-6 py-2 rounded-md bg-accent-red text-white font-semibold hover:bg-opacity-90">Save
                                Changes</button>
                        </div>
                    </div>
                </form>
