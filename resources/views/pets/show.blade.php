        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <a href="{{ route('pets.index', ['category' => $pet->category->slug]) }}"
                    class="inline-flex items-center text-text-secondary hover:text-text-primary transition group">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    {{-- Shelter Information --}}
                    <div class="mb-6">
                        <h3 class="text-xl font-semibold text-text-primary mb-4">{{ $pet->shelter->name }}</h3>
