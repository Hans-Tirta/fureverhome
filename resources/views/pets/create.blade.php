    ...
    <div class="min-h-screen bg-background-primary py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-8">
                <h1 class="text-3xl font-bold text-text-primary">{{ __('pets.form.create') }}</h1>
                ...
                <form method="POST" action="{{ route('pets.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="p-6 space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="gender"
                                        ...
                                        <option value="male" {{ old('gender') == 'male' ? 'selected' : '' }}>{{ __('pets.form.fields.male') }}</option>
                                        <option value="female" {{ old('gender') == 'female' ? 'selected' : '' }}>{{ __('pets.form.fields.female') }}</option>
                                    </select>
                                    @error('gender')
                                        <p class="text-accent-red text-sm mt-1">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="size"
                                        ...
                                        <option value="small" {{ old('size') == 'small' ? 'selected' : '' }}>{{ __('pets.form.fields.small') }}</option>
                                        <option value="medium" {{ old('size') == 'medium' ? 'selected' : '' }}>{{ __('pets.form.fields.medium') }}</option>
                                        <option value="large" {{ old('size') == 'large' ? 'selected' : '' }}>{{ __('pets.form.fields.large') }}</option>
                                    </select>
                                    @error('size')
                                        <p class="text-accent-red text-sm mt-1">{{ $message }}</p>
                                    @enderror
                        ...
                        <div>
                            ...
                            <p class="text-sm text-text-secondary mb-2">{{ __('pets.form.fields.images_help') }}</p>
                        ...
                        <div class="flex items-center justify-end gap-3 pt-4 border-t border-background-secondary">
                            ...
                            <button type="submit"
                                class="px-6 py-2 rounded-md bg-accent-red text-white font-semibold hover:bg-opacity-90">{{ __('pets.form.create') }}</button>
                        </div>
                    </div>
                </form>
            </div>
