<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            {{ __('profile.shelter.title') }}
        </h2>

        <p class="mt-1 text-sm text-gray-600">
            {{ __('profile.shelter.description') }}
        </p>
        ...
        @else
            <div class="mt-3 p-3 bg-green-50 border border-green-200 rounded-md">
                <p class="text-sm text-green-800 flex items-center">
                    ...
                    <strong>{{ __('profile.shelter.verified') }}</strong>
                </p>
            </div>
        @endif
    </header>
    ...
    <form method="post" action="{{ route('profile.shelter.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="shelter_name" :value="__('profile.shelter.name')" />
        ...
        <div>
            <x-input-label for="address" :value="__('profile.shelter.address')" />
        ...
        <div>
            <x-input-label for="phone" :value="__('profile.shelter.phone')" />
        ...
        <div>
            <x-input-label for="shelter_email" :value="__('profile.shelter.contact_email')" />
        ...
        <div>
            <x-input-label for="description" :value="__('profile.shelter.description_label')" />
        ...
        <div>
            <x-input-label for="website" :value="__('profile.shelter.website')" />
