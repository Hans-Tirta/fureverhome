        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p class="text-text-secondary mt-1">Create and manage your articles</p>
                </div>
                                    ...
                                    <tr class="hover:bg-gray-50 transition">
                                        <td class="px-6 py-4">
                                            <div class="flex items-center">
                                                ...
                                                @else
                                                    <div class="h-12 w-16 rounded bg-gradient-to-br from-red-400 to-orange-400 mr-3 flex-shrink-0 flex items-center justify-center">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="h-8 w-8 rounded-full bg-gradient-to-br from-accent-red to-accent-orange flex items-center justify-center text-white text-xs font-bold mr-2">
