...
return [
    ...
    */
    ...
    'hero' => [
        ...
        'subtitle' => 'Jelajahi dan temukan hewan peliharaan menakjubkan dari shelter terpercaya di dekat Anda',
    ],
    ...
    'how_it_works' => [
        ...
        'steps' => [
            'browse' => [
                'title' => '1. Jelajahi Hewan Peliharaan',
                'description' => 'Telusuri database kami yang berisi hewan peliharaan lucu dari shelter terverifikasi',
                'alt' => 'Jelajahi hewan peliharaan',
            ],
            'contact' => [
                'title' => '2. Hubungi Shelter',
                'description' => 'Hubungi shelter secara langsung menggunakan informasi kontak yang tersedia',
                'alt' => 'Hubungi shelter',
            ],
            'adopt' => [
